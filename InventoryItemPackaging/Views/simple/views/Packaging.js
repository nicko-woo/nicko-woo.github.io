var PackagingView = function ($scope, $element, $filter, $compile, $q, $http) {
  var self = this;
  $scope.stockItemId = $scope.$parent.$parent.$parent.$parent.itemId;
  $scope.headerInfo = $scope.$parent.$parent.$parent.$parent.headerInfo;
  let plkrFrame = document.getElementById("plkrFramePackaging");
  let url_string = "https://application.doodle-products.com/";

  let frameUrl = url_string + "?itemGuidPackaging=" + $scope.stockItemId;
